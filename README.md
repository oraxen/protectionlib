...
```yaml
   softdepend: [ WorldGuard, Towny, Factions, Lands, PlotSquared, CrashClaim, Citizens]
```
...
- [Citizens](https://www.spigotmc.org/resources/citizens.13811/) (Free)
